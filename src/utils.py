...
file_handler = logging.FileHandler(r'C:\Users\user\PycharmProjects\homework\logs\utils.log', mode='w', encoding='utf-8')
...
def data_for_transactions(file_path: str) -> list:
    ...
    try:
        logger.info('Принимается путь до JSON-файла и возвращается список словарей с данными о финансовых транзакциях.')
